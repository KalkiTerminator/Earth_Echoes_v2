...
// service-account credential drives synthesis (Claude), validation (Gemini
// thinking), and media (Gemini multimodal). Model ids are env-configurable.
...
/** Claude Haiku on Vertex — synthesizes/reconciles the species record. */
export const synthModel = () => ensure(anthropic, "synthesis")(env.ingest.synthModel);
